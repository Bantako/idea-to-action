...
### Step 8: AI によるテーマ名提案（Graph整理時）

繋がりの強いノード群を選択したときに、AIがテーマ名の候補を出す。
複数選択 → テーマ命名ダイアログ に AI 提案を差し込む形。

- 複数選択されたノードのタイトルを AI に渡す
- AI がテーマ名を 2〜3 候補返す
- ダイアログ内に候補チップとして表示、タップで入力欄に反映
- APIキー未設定時はスキップ（候補なしで手動入力のみ）
